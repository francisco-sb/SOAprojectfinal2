...
/**
 * <p>
 * Clase que sirve para realizar las tareas comunes para interactuar con una
 * Base de Datos en MySQL. Realiza las tareas de insertar, borrar y actualizar
 * registros, así como de llevar a cabo consultas en alguna tabla
 * especificada.</p>
 * <p>
 * Un ejemplo de las sentencias SQL esperadas por los métodos:</p>
 * <table border="1">
 * <tr><td>Acción</td><td>Sentencia SQL</td></tr>
 * <tr><td>Consulta</td><td>SELECT column_name(s) FROM table_name WHERE
 * column_name operator value</td></tr>
 * <tr><td>Insertar</td><td>INSERT INTO table_name VALUES (value1, value2,
 * value3,...)</td></tr>
 * <tr><td>Borrar</td><td>UPDATE table_name SET column1=value,
 * column2=value2,... WHERE some_column=some_value</td></tr>
 * <tr><td>Actualizar</td><td>DELETE FROM table_name WHERE
 * some_column=some_value</td></tr>
 * </table>
 */
public class Conexion {
    ...
    /**
     * <p>
     * Constructor para crear la conexión a la Base de Datos a través de
     * {@code JBDC}. Los datos que requiere son el usuario, la contraseña y la
     * base de datos a utilizar.</p>
     *
     * @param userDB El nombre de usuario con el cual debe hacerse la conexión a
     * la Base de Datos.
     * @param passDB La contraseña para llevar a cabo la conexión a la Base de
     * Datos.
     * @param projectDB El nombre de la Base de Datos a utilizar.
     * @throws ClassNotFoundException Si el conector {@code JDBC} no se
     * encuentra.
     * @throws SQLException Si sucede algún error en la conexión a la Base
     * Datos.
     */
    public Conexion(String userDB, String passDB, String nameDB) throws ClassNotFoundException, SQLException {
        try {
            Class.forName("org.gjt.mm.mysql.Driver"); //Comprobar el conector
            //conexion = DriverManager.getConnection("jdbc:mysql://localhost/"+usrBD, userDB, passBD);
            conexion = DriverManager.getConnection("jdbc:mysql://localhost/" + nameDB, userDB, passDB);
    ...
    /**
     * Busca la cantidad de registros que hay en la tabla especificada. Devuelve
     * -1 en caso de haber algún error
     *
    ...
    /**
     * Cerrar la conexión con la BD. Cuando ya no se necesite usar la conexión a
     * la BD, es recomendable cerrarla. No se puede volver a utilizar el objeto
